...
var $ = jQuery; // add event listeners for project overlays

$(".activate-apod").on("click", activateApod);
$(".activate-uw").on("click", activateUW);
$(".activate-newsletter").on("click", activateNewsletter); // event listeners for closing overlay when nav link clicked

$("nav a").on("click", dismissOverlay); // overlay background exit click listener

$("#overlay-slip, .close-overlay").on("click", historyGoBack); // listen for window back button
...
function checkScroll(e) {
  var activeOverlay = $(".active")[0]; // check min or max scroll
...
},{"smooth-scroll":"../node_modules/smooth-scroll/dist/smooth-scroll.polyfills.min.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
